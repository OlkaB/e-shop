...
export class ProductsOpinionsService {
  ...
  new ProductsOpinionsModel('1_0001', [
    ...
    new OpinionModel('Waldi', "1_0001_2", 4.5, "Fantastic", "Fantastic car for old timers lovers", "2017-09-04"),
    ]),
  new ProductsOpinionsModel('3_001', [
    new OpinionModel('Andy', "3_001_1", 3.5, "Good but a bit long", "They made it great, check everything in details, but it took so long, when i was in hurry", "2017-11-15"),
